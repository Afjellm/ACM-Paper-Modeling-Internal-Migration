...
OUTPUT_PATH = project_root / "models" / "output" / "xgboost_output"


def run_experiment_and_write_results(fit_years, X_DATA, Y_DATA, data, grid_search, experiment_name, START_YEAR, END_YEAR, age_group, Y_AMOUNT_DATA, features_for_training):
    ...
    with open(pipeline_save_path / f"features_importances_{age_group}.csv", "w") as f:
